      ...
      <section className="md:py-16 py-8 px-4 flex flex-col gap-4 md:flex-row leading-5 font-extralight dark:font-thin rounded-xl mx-auto items-center justify-center backdrop-blur-md bg-primary/10">
        ...
        <article className="flex-1 flex flex-col gap-4">
          <aside className="flex-1 leading-normal">
            ...
            <p className="text-2xl text-balance">Jr. Software Developer <Link href={siteConfig.companyurl} className={cn(buttonVariants({variant:"link",className:"text-2xl p-0 m-0"}))}>@Epam</Link></p>
            <p className="text-2xl text-balance">Full stack developer, JavaScript</p>
          </aside>
          <aside className="flex flex-col md:flex-row flex-1 gap-2">
            <Link href="/resume.pdf"  className={cn(buttonVariants({variant:"default",className:"flex-auto  min-w-fit"}))}>Resume</Link>
            <Button
